...
class BillController {
    static async addBill(req, res, next) {
        try {
            const { name, phone, city, address, price, delivery, items , user_id, customer_name,customer_phone ,customer_total , customer_nearpoint} = req.body;
            const result = await Bill.addBill(name, phone, city, address, price, delivery, items,user_id,customer_name, customer_total , customer_nearpoint);
